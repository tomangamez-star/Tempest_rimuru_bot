...
const config = {
  ...
  shop: { items: [{ id: 'crowbar', name: 'Crowbar', emoji: '🪓', price: 25000, desc: 'Required for robbery-type crimes.' }, { id: 'gun', name: 'Gun', emoji: '🔫', price: 75000, desc: 'Required for armed robbery crimes.' }, { id: 'mask', name: 'Robbery Mask', emoji: '🎭', price: 20000, desc: 'Required for robbery crimes.' }, { id: 'hook', name: 'Fishing Hook', emoji: '🎣', price: 15000, desc: 'Required to /fish.' }, { id: 'security', name: 'Security', emoji: '🛡️', price: 100000, desc: 'Boosts escape odds (+10%).' }, { id: 'cyber', name: 'Cyber Security', emoji: '💻', price: 200000, desc: 'Defense against heists (+15%).' }, { id: 'lockpick', name: 'Lockpick', emoji: '🗝️', price: 30000, desc: '+8% crime success.' }, { id: 'lucky', name: 'Lucky Charm', emoji: '🍀', price: 50000, desc: '+5% crime success.' }, { id: 'drill', name: 'Drill', emoji: '🛠️', price: 125000, desc: '+12% crime success.' }], crime: { minBet: 5000, maxBet: 2000000, baseSuccess: 0.45, itemBonus: { crowbar: 0.10, gun: 0.12, mask: 0.06, lockpick: 0.08, lucky: 0.05, drill: 0.12 }, securityEscapeBonus: 0.10, cyberDefenseBonus: 0.15 } },
  fish: { catchLines: [(c) => `🐟 You reel in a fat carp — sold for **${c}**.`, (c) => `🐠 A shimmering tuna! **${c}**.`, (c) => `🦑 A rare squid — the market pays **${c}**.`, (c) => `🦞 A lobster! Dinner AND profit: **${c}**.`], junkLines: [`👢 You hooked an old boot. Nothing but shame.`, `🪣 A rusty bucket. The fish laughed at you.`, `🌿 Just seaweed. The ocean is mocking you.`] },
